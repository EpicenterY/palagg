...
- **Box / Grid / Tag 형상 선택** — 수납 박스, 칸막이 정리함, 네임태그
...
- **Tag 모드** — 텍스트 입력 또는 24개 내장 아이콘 선택, 멀티컬러 3MF 내보내기
- **Iconify 아이콘 검색** — Material Symbols 15,000+ 아이콘 검색/선택, localStorage 영속화
...
│       │   ├── model/          — CSG 모델 생성, 3MF 변환, SVG 파싱, TMFLoader
...
4. **Tag 모드** — 텍스트 입력 또는 아이콘 선택 (내장 24개 + Iconify 15,000+)
5. **3D 프리뷰** — 실시간 애니메이션, 터치/마우스 회전
6. **다운로드** — 단건 3MF 다운로드 또는 주문서에 추가 후 ZIP 일괄 다운로드
